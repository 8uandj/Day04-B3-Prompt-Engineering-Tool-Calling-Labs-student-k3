...
[data-testid="stSidebar"]{background:linear-gradient(180deg,#002d58,#001d3b)}[data-testid="stSidebar"] *{color:#f8fbff}[data-testid="stSidebar"] [data-baseweb="select"] *{color:var(--ink)}[data-testid="stSidebar"] input{color:var(--ink)!important}
...
with st.sidebar:
    ...
    version = st.text_input("Artifact version", "v3", help="Label stored in the transcript, e.g. v0, v1, v2, v3.")
