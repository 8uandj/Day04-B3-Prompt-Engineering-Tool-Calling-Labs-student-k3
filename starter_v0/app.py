...
load_lab_env(ROOT)
st.set_page_config(page_title="Research Command Center", page_icon="◆", layout="wide", initial_sidebar_state="expanded")
...
[data-testid="stSidebar"]{background:linear-gradient(180deg,#002d58,#001d3b)}[data-testid="stSidebar"] label,[data-testid="stSidebar"] p,[data-testid="stSidebar"] h1,[data-testid="stSidebar"] h2,[data-testid="stSidebar"] h3,[data-testid="stSidebar"] span{color:#f8fbff!important}[data-testid="stSidebar"] [data-baseweb="select"]>div,[data-testid="stSidebar"] [data-baseweb="input"]>div{background:rgba(255,255,255,.10)!important;border-color:rgba(255,255,255,.35)!important}[data-testid="stSidebar"] [data-baseweb="select"] *,[data-testid="stSidebar"] [data-baseweb="input"] *,[data-testid="stSidebar"] input{color:#fff!important;caret-color:#fff!important}[data-testid="stSidebar"] [data-baseweb="select"] svg{fill:#fff!important}[data-baseweb="popover"],[data-baseweb="menu"]{background:#003b71!important}[data-baseweb="popover"] *,[data-baseweb="menu"] *{color:#fff!important}header{visibility:visible!important;background:transparent!important}[data-testid="stToolbar"]{display:none!important}[data-testid="stSidebarCollapseButton"]{background:rgba(255,255,255,.12)!important;border-radius:8px}[data-testid="stSidebarCollapseButton"] svg{fill:#fff!important}
...
with st.sidebar:
    st.markdown("### ◆ Research Agent\nLive tool-calling workspace for evaluation, evidence, and demo rehearsal. Use the chevron at top-left to collapse or expand this panel.")
